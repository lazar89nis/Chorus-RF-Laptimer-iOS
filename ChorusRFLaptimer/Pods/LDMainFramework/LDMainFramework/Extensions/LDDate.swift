...
extension Date
{
    ...
    static public func ldDateFromString(_ strDate: String?, stringFormat: String = "yyyy-MM-dd HH:mm:ss") -> Date?
    {
    ...
    static public func ldStringFromDate(_ date: Date, stringFormat: String = "yyyy-MM-dd HH:mm:ss") -> String
    {
        let dateFormatter = DateFormatter()
        dateFormatter.dateFormat = stringFormat
    ...
    static public func ldStringFromStringDate(_ strDate: String,
