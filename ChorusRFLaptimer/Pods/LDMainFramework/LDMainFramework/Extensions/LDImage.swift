...
extension UIImage
{
    ...
    open func ldResized(withPercentage percentage: CGFloat) -> UIImage?
    {
    ...
    /// - Returns: Resized UIImage object
    open func ldResized(toWidth width: CGFloat) -> UIImage?
    {
    ...
    open func ldOverlay(with color: UIColor) -> UIImage? {
        return self.ldPerformBlend(blendMode: .overlay, color: color)
    }
    ...
    open func ldSoftLight(with color: UIColor) -> UIImage? {
        return self.ldPerformBlend(blendMode: .softLight, color: color)
    }
    ...
    open func ldPerformBlend(blendMode:CGBlendMode, color:UIColor) -> UIImage?
    {
    ...
    open func ldCropImage(toRect rect:CGRect) -> UIImage? {
        var rect = rect
    ...
    open func ldConvertToGrayScale() -> UIImage {
    ...
    open func ldBlur(blurRadius:CGFloat = 10.0) -> UIImage {
    ...
    open func ldAlpha(_ value:CGFloat) -> UIImage {
